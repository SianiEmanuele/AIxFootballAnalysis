...
def main():
    images_input_path = r"dataset\yolov9\v2\test\images"
    model_path = r"src/training/yolo_football_analysis/yolo9c_dataset_v2_high_res2/weights/best.pt"
    model_name = "yolo9c_dataset_v2_high_res2"
